        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-16">
            ...
            <div className="lg:col-span-2 space-y-10">
              {/* Quick contact */}
              <div>
                <h3 className="text-lg font-bold text-gray-900 mb-4">Get in Touch Directly</h3>
              ...
              <div>
                ...
                <div className="space-y-6">
                  {offices.map((office) => (
                    <div key={office.city} className="bg-gray-50 rounded-xl p-5 border border-gray-100">
                      <h4 className="font-semibold text-gray-900 mb-2">{office.city}</h4>
                      <div className="space-y-1 text-sm text-gray-600">
                        <p>{office.address}</p>
                        <p>{office.region}</p>
                        <a href={`tel:${office.phone.replace(/[^+\d]/g, "")}`} className="block hover:text-primary-700 transition-colors">
                          {office.phone}
                        </a>
                        <a href={`mailto:${office.email}`} className="block hover:text-primary-700 transition-colors">
                          {office.email}
                        </a>
                      </div>
                    </div>
